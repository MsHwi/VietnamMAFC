 // ***********************************************************************************************
 // Program Name : [CRPT2011] Daily Agent Performance Report Script
 // Creator      : jekalhg@buttle.co.kr
 // Create Date  : 2018. 03. 14
 // Description  : Daily Agent Performance Report
 // Modify Desc  : 
 // -----------------------------------------------------------------------------------------------
 // Date         | Updater        | Remark
 // -----------------------------------------------------------------------------------------------
 ...
 //        
 // ***********************************************************************************************/
corebase.wrapping("#CRPT2011", function($cbwrap, $cbfind, corebase) {
	...
	function fn_srch() {
	    ...
	    corebase.selectList ( source, "CRPT2011.SELECT_DAY_AGEN_PFMC", function ( output, metadata ){
	...
	function fn_exptFile(type) {
	    ...
	    data.SELECT_DAY_AGEN_PFMC = corebase.Input("selectList", "CRPT2011.SELECT_DAY_AGEN_PFMC", source, header); // select query
