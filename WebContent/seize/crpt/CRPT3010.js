...
corebase.wrapping("#CRPT3010", function($cbwrap, $cbfind, corebase) {
	...
	function fn_srch() {
	    ...
	    corebase.selectList ( source, "CRPT3010.SELECT_EMPTY_LIST", function ( output, metadata ){
	...
	function fn_exptFile(type) {
	    ...
	    data.SELECT_EMPTY_LIST = corebase.Input("selectList", "CRPT3010.SELECT_EMPTY_LIST", source, header); // select query
