...
corebase.wrapping("#CRPT3011", function($cbwrap, $cbfind, corebase) {
	...
	function fn_srch() {
		...
		corebase.selectList(source, "CRPT3011.SELECT_CNSL_TYPE_CNT", function(output, metadata) {
	...
	function fn_exptFile(type) {
		...
		data.SELECT_DAY_CALL_STS = corebase.Input("selectList", "CRPT3011.SELECT_CNSL_TYPE_CNT", source, header); // select query
