...
corebase.wrapping("#CRPT1014", function($cbwrap, $cbfind, corebase) {
	...
	function fn_srch() {
		...
		corebase.selectList(source, "CRPT1014.SELECT_LEAD_PFMC", function(output, metadata) {
	...
	function fn_exptFile(type) {
		...
		data.SELECT_LEAD_PFMC = corebase.Input("selectList", "CRPT1014.SELECT_LEAD_PFMC", source, header); // select query
