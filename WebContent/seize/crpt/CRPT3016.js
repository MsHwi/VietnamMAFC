...
corebase.wrapping("#CRPT3016", function($cbwrap, $cbfind, corebase) {
	...
	function fn_srch() {
	    ...
	    corebase.selectList ( source, "CRPT3016.SELECT_EMPTY_LIST", function ( output, metadata ){
	...
	function fn_exptFile(type) {
	    ...
	    data.SELECT_EMPTY_LIST = corebase.Input("selectList", "CRPT3016.SELECT_EMPTY_LIST", source, header); // select query
