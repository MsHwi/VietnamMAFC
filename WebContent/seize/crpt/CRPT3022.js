...
corebase.wrapping("#CRPT3022", function($cbwrap, $cbfind, corebase) {
    ...
    function fn_srch() {
        ...
        corebase.selectList(source, "CRPT3022.SELECT_AGREE_DTLS", function ( output, metadata ) {
    ...
    function fn_exptFile(type) {
        ...
        data.SELECT_AGREE_DTLS = corebase.Input("selectList", "CRPT3022.SELECT_AGREE_DTLS", source, header); // select query
