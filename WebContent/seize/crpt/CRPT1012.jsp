...
<!-- 
 // ***********************************************************************************************
 // Program Name : [CRPT1012] O/B Monthly Call Report
...
<cb:pageWrapper title="Monthly Call Report" id="CRPT1012" plugin="datepicker,grid" pageType="">
           ...
           <colgroup>
            ...
            <tbody> 
                <tr>
                    ...
                    <td><cbt:combo code="selectList:CRPT1012.SELECT_CMP" name="" id="CMB_CMP_CD"  data-option="event:init;top:ALL"  data-io="IO" style="width:100%;" codeType="ALL"/></td>
                                    </tr>
                <tr>
        ...
        <article class="gridArea">
            <cb:grid style=" position:absolute; top:0; bottom:30px; width:100%;" data-option="type:spread">
                <table id="GRD_RPT" class="spread" data-spread="operationmode:3;scrollbars:virtual;pagesize:20;">
                    <thead>
                        <tr>
                            <cb:grid-column id="DT"         width="150px"   data-column="align:center;type:date;"><cbt:message code="txt.1219" text="Date" /></cb:grid-column>
    ...
    <script type="text/javascript" charset="utf-8" src="/seize/crpt/CRPT1012.js"></script>
