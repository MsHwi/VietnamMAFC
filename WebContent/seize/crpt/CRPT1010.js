 // ***********************************************************************************************
 // Program Name : [CRPT1010] O/B Monthly Call Report
 ...
 //        
 // ***********************************************************************************************/
corebase.wrapping("#CRPT1010", function($cbwrap, $cbfind, corebase) {
	...
	function fn_srch() {
	    ...
	    corebase.selectList ( source, "CRPT1010.SELECT_HOURY_CALL", function ( output, metadata ){
	...
	function fn_exptFile(type) {
	    ...
	    data.SELECT_HOURY_CALL = corebase.Input("selectList", "CRPT1010.SELECT_HOURY_CALL", source, header); // select query
