...
<!-- 
 // ***********************************************************************************************
 // Program Name : [CRPT2012] I/B Weekly Call Report
 // Creator      : jekalhg@buttle.co.kr
 // Create Date  : 2018. 03. 14
 // Description  : I/B Weekly Call Report Screen
 // Modify Desc  : 
 // -----------------------------------------------------------------------------------------------
 // Date         | Updater        | Remark
 // -----------------------------------------------------------------------------------------------
...
<cb:pageWrapper title="Weekly Call Report" id="CRPT2012" plugin="datepicker,grid" pageType="">
            	 ...
            	 <tr>
                    ...
                    <td colspan="6">
                        ...
                        <div class="item inline">
                            <input name="SRCH_RD_DT" type="radio" value="W" id="c3" class="i_radio" checked="checked" /> <label for="c3"><cbt:message code="txt.2430" text="This Week" /></label>
                            <input name="SRCH_RD_DT" type="radio" value="M" id="c4" class="i_radio" /> <label for="c4"><cbt:message code="txt.2162" text="Last Week" /></label>
                        </div>
                    </td>
                </tr>
                <tr>
    ...
    <div style="position:absolute; top:70px;">
        ...
        <section class="area_rel100">
            <!--boxst01-->
            <table id="WKLY_CALL_TOT" class="boxst01">
                <colgroup>
                    <col style="width:10%" />
                    <col style="width:" />
                    <col style="width:10%" />
    ...
    <!--GridArea-->
    <section style="position:absolute; top:130px; right:0; bottom:0; left:0;">
        <!--Grid-->
    ...
    <script type="text/javascript" charset="utf-8" src="/seize/crpt/CRPT2012.js"></script>
