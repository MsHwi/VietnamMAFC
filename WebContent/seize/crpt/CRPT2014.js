 // ***********************************************************************************************
 // Program Name : [CRPT2014] I/B Monthly Agent Performance Report Script
 // Creator      : jekalhg@buttle.co.kr
 // Create Date  : 2018. 03. 14
 // Description  : I/B Monthly Agent Performance Report
 // Modify Desc  : 
 // -----------------------------------------------------------------------------------------------
 // Date         | Updater        | Remark
 // -----------------------------------------------------------------------------------------------
 ...
 //        
 // ***********************************************************************************************/
corebase.wrapping("#CRPT2014", function($cbwrap, $cbfind, corebase) {
	...
	function fn_srch() {
	    ...
	    corebase.selectList ( source, "CRPT2014.SELECT_MMLY_AGEN_PFMC", function (output, metadata){
	...
	function fn_exptFile(type) {
	    ...
	    data.SELECT_MMLY_AGEN_PFMC = corebase.Input("selectList", "CRPT2014.SELECT_MMLY_AGEN_PFMC", source, header); // select query
