 ...
 //        
 // ***********************************************************************************************/
corebase.wrapping("#CRPT1012", function($cbwrap, $cbfind, corebase) {
	...
	function fn_srch() {
	    ...
	    corebase.selectList ( source, "CRPT1012.SELECT_MONTHLY_CALL", function ( output, metadata ){
	...
	function fn_exptFile(type) {
	    ...
	    data.SELECT_MONTHLY_CALL = corebase.Input("selectList", "CRPT1012.SELECT_MONTHLY_CALL", source, header); // select query
