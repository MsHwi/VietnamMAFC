...
<!-- 
 // ***********************************************************************************************
 // Program Name : [CRPT1010] O/B Hourly Call Report
...
<cb:pageWrapper title="Hourly Call Report" id="CRPT1010" plugin="datepicker,grid" pageType="">
        ...
        <table cellspacing="0" class="SrchTBL">
            ...
            <tbody> 
                <tr>
                    ...
                    <td><cbt:combo code="selectList:CRPT1010.SELECT_CMP" name="" id="CMB_CMP_CD"  data-option="event:init;top:ALL"  data-io="IO" style="width:100%;" codeType="ALL"/></td>
                    <td></td>
                </tr>
                <tr>
        ...
        <article class="gridArea">
            <cb:grid style=" position:absolute; top:0; bottom:30px; width:100%;" data-option="type:spread">
                <table id="GRD_RPT" class="spread" data-spread="operationmode:3;scrollbars:virtual;pagesize:20;">
                    <thead>
                        <tr>
                            <cb:grid-column id="TEAM_NM"    width="*"   data-column="align:left;"><cbt:message code="txt.1504" text="Team Name" /></cb:grid-column>
                            <cb:grid-column id="TM"         width="150px"   data-column="align:center;"><cbt:message code="txt.1073" text="Time" /></cb:grid-column>
                            <cb:grid-column id="FRSH_DATA"  width="150px"   data-column="align:right;type:number"><cbt:message code="txt.2109" text="Fresh Data" /></br>(<cbt:message code="txt.2230" text="not call ever" />)</cb:grid-column>
                            <cb:grid-column id="WIP_DATA"   width="170px"   data-column="align:right;type:number"><cbt:message code="txt.2479" text="Wip Data" /></br>(<cbt:message code="txt.1931" text="called connect before" />)</cb:grid-column>
                            <cb:grid-column id="TLKTM_TOT"	width="150px"   data-column="align:right;type:number"><cbt:message code="txt.2406" text="Talktime Total" /></cb:grid-column>
                            <cb:grid-column id="AVG_DURT"   width="150px"   data-column="align:right;type:number"><cbt:message code="txt.1905" text="Average duration" /></cb:grid-column>
                            <cb:grid-column id="NO_CONN"    width="150px"   data-column="align:right;type:number"><cbt:message code="txt.2226" text="No Connect" /></cb:grid-column>
                            <cb:grid-column id="CALL_TOT"   width="150px"   data-column="align:right;type:number"><cbt:message code="txt.1402" text="Total Call" /></cb:grid-column>
                        </tr>
                    </thead>
                </table>
            </cb:grid>
    ...
    <script type="text/javascript" charset="utf-8" src="/seize/crpt/CRPT1010.js"></script>
